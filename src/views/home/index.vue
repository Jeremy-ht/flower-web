<template>
  <div class="home-container">
    ...
    <div class="content-show" v-show="showIndex == 1">
      ...
      <div class="feature">
        <div class="bor">
          <h1 style="margin-bottom: -10px;">热销榜单</h1>
      ...
      <div class="feature">
        <div class="bor">
          <h1 style="margin-bottom: -10px;">鲜花礼盒</h1>
    ...
    <div class="content-show" v-show="showIndex == 2">
      <div class="new bor">
        <div class="bor" style="margin-top: 10px">
          <h1 style="margin-bottom: -20px;padding-left: 30px">{{categoryname}}</h1>

          <div class="new-item11">

            <div class="new-item-list33" v-for="item in otherList" :index="item.id">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 去首页
      goHome() {
        this.$router.push({ path: `/flower/home` })
      },
